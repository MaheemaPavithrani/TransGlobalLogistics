		...
		<div class="form-group">
	      <label for="inputEmail" class="col-lg-4 control-label">User Name</label>
	        <div class="col-lg-8">
	        	...
	        	<?php echo form_input(['name'=>'username','class'=>'form-control', 'placeholder'=>'User Name','value'=>set_value('username',$record->username)]); ?>
	        </div>
		  </div>
		</div>
		<div class="col-lg-9"></div>
		...
		<div class="form-group">
	      <label for="inputEmail" class="col-lg-4 control-label">Password</label>
	        <div class="col-lg-8">
	        	...
	        	<?php echo form_input(['name'=>'password','class'=>'form-control', 'placeholder'=>'Password','type'=>"password",'value'=>set_value('password',$record->password)]); ?>
	        </div>
		  </div>
		</div>
		<div class="col-lg-9"></div>
